...
function connectSSE() {
  ...
  eventSource.onmessage = function (event) {
    try {
      ...
      const loadingDetails = document.getElementById("loading-details") as HTMLElement | null;
      ...
      const startScrapeBtn = document.getElementById("start-scrape") as HTMLButtonElement | null;
      const stopScrapeBtn = document.getElementById("stop-scrape") as HTMLButtonElement | null;
      ...
      // --- Add/Update Table Row ---
        ...
        function getJsEpisodeSortValue(epCountStr: string) {
