...
$(function() {
   ...
   $("#favorites-table").tablesorter({ // Target favorites table
       theme: 'bootstrap',
  ...
  $("#select-all").on("change", function() {
      ...
      $("#favorites-table tbody input[name='selected_anime']").prop("checked", isChecked); // Target favorites table
  });
   $("#favorites-table tbody").on("change", "input[name='selected_anime']", function() { // Target favorites table
